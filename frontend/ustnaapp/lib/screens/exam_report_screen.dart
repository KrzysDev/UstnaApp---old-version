            ...
            result.errors.isEmpty
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: const Color(0xFF4EAD77).withOpacity(0.2),
                      ),
                    ),
                    child: Row(
                      children: [
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isCardinal = error.errorType.toLowerCase().contains(
                        'kardynaln',
                      );
                      final errorColor = isCardinal
                          ? const Color(0xFFE55C5C)
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              // FIXED: Limit maxLines for long error descriptions
                              Text(
