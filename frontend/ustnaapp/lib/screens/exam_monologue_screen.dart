...
class _ExamMonologueScreenState extends State<ExamMonologueScreen>
  ...
  Future<void> _navigateToBoardQuestions(ExamProvider provider) async {
    ...
    if (mounted) {
      ...
      if (provider.errorMessage != null) {
        ...
        Navigator.of(
          context,
        ).push(MaterialPageRoute(builder: (_) => const ExamBoardScreen()));
      }
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    if (_transcriptController.text.isEmpty &&
                        !provider.isTranscribingMonologue) ...[
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            // FIXED: Use Container with fixed height for scrollable text
                            Container(
                              ...
                              child: TextField(
                                ...
                                maxLines: null,
                                expands:
                                    false, // Important: don't expand, let text scroll inside container
                                ...
                                decoration: InputDecoration(
                                  hintText:
                                      'Tutaj pojawi się transkrypcja Twojej wypowiedzi...',
