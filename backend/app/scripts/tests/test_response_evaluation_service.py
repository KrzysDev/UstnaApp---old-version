...
1. Kreon uważał, że jako władca musi dbać o powagę władzy państwowej i bezwzględne przestrzeganie prawa. 
Ułaskawienie Antygony, która była jego krewną, mogłoby zostać odebrane jako nepotyzm i słabość, 
co mogłoby doprowadzić do buntu poddanych lub anarchii w państwie. Dlatego odrzucił argumenty Hajmona 
i uważał porządek społeczny za absolutny priorytet.

2. Tak, istnieją pewne różnice. Tomasz Morus działał w realiach nowożytnego państwa chrześcijańskiego 
i powoływał się na autorytet papieża oraz Kościoła katolickiego. Antygona natomiast odwoływała się do 
niepisanych praw boskich związanych z tradycją religijną antycznej Grecji oraz więzami rodzinnymi. 
Jednak ich nadrzędny motyw – wierność sumieniu i prawu wyższemu ponad ludzki edykt – pozostał identyczny.
"""
...
print(f"\nWypowiedź ucznia (1): {student_answer[:300]}...")

print(f"\nPytanie drugie (2): {question2}")
print(f"\nWypowiedź ucznia (2): {student_answer_2[:300]}...")

print(f"\nPytanie komisji 1: {examination_board_question1}")
print(f"\nPytanie komisji 2: {examination_board_question2}")

print("\nOdpowiedzi ucznia (rozmowa):")
print(examination_board_answers[:400] + "...")

print("\nOcenianie z uwzględnieniem pełnego egzaminu... (może potrwać chwilę)\n")
