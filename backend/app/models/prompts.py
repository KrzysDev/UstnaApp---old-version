...
1. Jedno zapytanie o kryteria oceniania dla specyfiki tego zadania.
2. Jedno lub dwa zapytania o lekturę/lektury wymienione w pytaniu lub odpowiedzi
...
5. Opcjonalnie: zapytanie o drugi tekst kultury przywołany przez ucznia.
...
Otrzymujesz pytanie egzaminacyjne, odpowiedź ucznia oraz wyselekcjonowane fragmenty
...
1. KRYTERIA OCENIANIA — najważniejsze zasady i progi punktowe istotne dla tej odpowiedzi
2. FAKTY O LEKTURZE / TEKŚCIE — kluczowe informacje o dziełach wymienionych w pytaniu
   lub odpowiedzi (fabuła, bohaterowie, motywy, autorstwo, data)
3. KONTEKST KULTUROWY / HISTORYCZNY — tło niezbędne do oceny przywołanych kontekstów
4. WZORCE I BŁĘDY — przykłady poprawnych odpowiedzi lub typowych błędów dla tego zagadnienia
